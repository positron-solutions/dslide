...
:END:
By default, blocks will clear results on entry, either forward or backward.  To retain them, set the action argument =:retain-results t=.  This might be useful if you have a figure that is not dynamic.
#+begin_src elisp
