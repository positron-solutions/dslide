...
Parents or the deck deciding default actions.  A parent wishing to show children inline may alter arguments to descendant actions, keeping compatibility between various combinations of actions.
